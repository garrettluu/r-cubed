...
void main(void) 
{
	...
	// i don't know what the * are for
	 ...
	 double d2;
	 equ_t func;
	 uint8_t xxNodes[1124][3]; //create the node arrays
	 uint8_t xyNodes[1124][3]; //why are they multidimensional? this is like 2am code so who knows
	 ...
	 gfx_SetTextFGColor( gfx_black );
   	 gfx_PrintStringXY( title1, 12, 12 ); //print title text
...
/*    do 
	...
	if (!lol3)
	{
		gfx_BlitRectangle(gfx_buffer,320-64,0,64,65); //blit the corner; take from the buffer and draw it on screen
